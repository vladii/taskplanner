...
public class GooglePlacesAutocompleteAdapter extends ArrayAdapter<GooglePlace> implements Filterable {
	...
	private ArrayList<GooglePlace> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            while (iterator.hasNext()) {
                ...
                place.setName(prediction.getDescription());
                place.setPlaceId(prediction.getPlaceId());
                place.setAddress(prediction.getDescription());
                
                // Get coordinates.
                GoogleGeodecodingAPI gDecode = new GoogleGeodecodingAPI(prediction.getPlaceId());
                place.setCoords(gDecode.getCoords());
