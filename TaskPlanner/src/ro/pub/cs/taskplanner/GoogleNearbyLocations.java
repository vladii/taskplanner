...
/* Class to find an objective near a fixed location.
 * How to use it:
 * GoogleNearbyLocations nearbyLoc =
 *				new GoogleNearbyLocations("banca transilvania", lat, lng);
 * nearbyLoc.getNearbyLocations() will give you a list of GooglePlaces
 * which match the criterias.
 * Note: you should know the exact lat (lattitude) and lng (longitude) of
 * your fixed location.
 */
